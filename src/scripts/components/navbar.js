class Navbar extends HTMLElement {
  ...
  render() {
    ...
    <div class="container flex flex-wrap justify-around items-center mx-auto">
      ...
      <div class="hidden w-full md:block md:w-auto" id="drawer">
        <ul class="flex flex-col mt-4 text-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
          ...
          <li>
            <a
              href="#/tasks"
              class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-purple-600 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
              >Task</a
            >
          </li>
          <li>
      ...
      <div class="hidden wfull md:block md:w-auto md:text-sm md:font-medium">
        <a
          href="#/profile"
          class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-purple-600 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
          >Profile</a
